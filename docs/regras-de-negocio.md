...
| Busca filtros (12.c–12.l) | ~~Não existe~~ `query` (12.c) + `ingredients[]`/`ingredientMatch` (12.d) em Prisma + in-memory + `GET /recipes` | Filtros 12.e–12.l restantes | **MF-27** ✅ (12.c); **MF-28** ✅ (12.d); MF-14 derivados |
